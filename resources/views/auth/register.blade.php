                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <label for="ndoc" class="col-form-label text-md-right text-register">{{ __('Número de Documento') }}</label>
                                <input id="ndoc" type="text" class="form-control form-control-sm @error('ndoc') is-invalid @enderror" name="ndoc" value="{{ old('ndoc') }}" required autocomplete="ndoc" autofocus>
