...
Route::get('/product/{gfather}/{father}/{son}', 'ProductController@groupSon');
Route::get('/product/{gfather}/{father}/{son}/{brand}', 'ProductController@groupByBand');
Route::get('/product/{gfather}','ProductController@groupGfa');
